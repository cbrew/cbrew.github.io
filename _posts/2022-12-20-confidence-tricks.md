...
Open AI's services are the marks. In my view Chat GPT is very impressive, but there are as yet no proven use cases aside from a few slightly direputable ones that we will get to in a moment, and one other that will take a while to mature.
...
That's not enough on its own, but I am pretty sure that someone with interesting things to say will be able to use it to write a good novel.
